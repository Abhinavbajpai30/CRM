import { ArrayInput, DateInput, Create, NumberInput, ReferenceInput, SimpleForm, SimpleFormIterator, TextInput, SelectInput, required } from 'react-admin';

const mandat = required('This field is required!');

export const ContentpieceCreate = () => (
    <Create>
        <SimpleForm>
